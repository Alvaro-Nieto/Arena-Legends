	...
	protected void buildStage() {
        ...
        p2Btn.addListener(new InputListener(){
			...
			public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
				...
				//CARGA DE UNA IMAGEN Y DESCRIPCI�N A LA DERECHA DE LA PANTALLA
				//NO FUNCIONA LA CARGA DE IMAGEN, HAY QUE SOLUCIONARLO
				personaje=new Image(drawaUnico);
				return false;
			}
        ...
        descripcion.row();
        //Falta a�adir una imagen por cada cualidad que determine el nivel que tiene de esa habilidad a la derecha o abajo       
        descripcion.add(cualidad1);
        descripcion.row();
